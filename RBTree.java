...
public class RBTree<K extends Comparable<? super K>, V> {
    ...
    private static void printHelper(Node<?, ?> n, int indent) {
        ...
        if (n.color == Color.BLACK) {
            ...
            //System.out.println("<" + n.key + "." + n.value + ">");
            //System.out.println(ANSI_RED + n.key + "." + n.value + ANSI_RESET);
            System.out.println(ANSI_RED + n.key + ANSI_RESET);
        }
        if (n.left != null) {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            //t.print();
            System.out.println("Deleting key " + y);
            System.out.println();
